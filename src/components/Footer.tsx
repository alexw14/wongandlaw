        ...
        <div className="flex-1 mt-8 md:mt-0 text-center md:text-left">
          ...
          <ul className="space-y-1 text-sm">
            <li className="flex items-center gap-2">
              <FaMapMarkerAlt className="inline text-[#FF8426]" size={20} />
              <span>
            ...
            <li className="flex items-center gap-2">
              <FaPhone className="inline text-[#FF8426]" size={20} />
              <a href="tel:6264477788" className="hover:text-[#FF8426]">
                626-447-7788
              </a>
            </li>
            <li className="flex items-center gap-2">
              <FaFax className="inline text-[#FF8426]" size={20} />
              <a href="fax:6264477783" className="hover:text-[#FF8426]">
                626-447-7783
              </a>
            </li>
            <li className="flex items-center gap-2">
              <FaEnvelope className="inline text-[#FF8426]" size={20} />
              <a
                href="mailto:info@wongandlaw.com"
                className="hover:text-[#FF8426]"
              >
                info@wongandlaw.com
              </a>
            </li>
            <li className="flex items-center gap-2">
              <FaWeixin className="inline text-[#FF8426]" size={20} />
